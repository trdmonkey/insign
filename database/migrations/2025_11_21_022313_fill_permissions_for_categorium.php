...
class FillPermissionsForCategorium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categorium',
            'admin.categorium.index',
            'admin.categorium.create',
            'admin.categorium.show',
            'admin.categorium.edit',
            'admin.categorium.delete',
            'admin.categorium.bulk-delete',
        ]);

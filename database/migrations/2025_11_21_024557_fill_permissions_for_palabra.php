...
class FillPermissionsForPalabra extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPalabra constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.palabra',
            'admin.palabra.index',
            'admin.palabra.create',
            'admin.palabra.show',
            'admin.palabra.edit',
            'admin.palabra.delete',
            'admin.palabra.bulk-delete',
        ]);

                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'rol'">{{ trans('admin.user.columns.rol') }}</th>
                                        <th is='sortable' :column="'estado'">{{ trans('admin.user.columns.estado') }}</th>
                                        <th is='sortable' :column="'color'">{{ trans('admin.user.columns.color') }}</th>
